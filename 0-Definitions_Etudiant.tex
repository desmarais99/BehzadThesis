...
\newcommand\mesMotsClef{Educational data mining, Model selection, NMF, POKS, IRT, Synthetic data, Cross validation, Predictive performance}
%%
%%  DEFINITION DU JURY
%%
