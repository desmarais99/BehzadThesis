...
\paragraph{Hypothesis 4:} Datasets with the same underlying  models but different data specific parameters can have different performance vectors. \note{I think there is a need to define the vocabulary before stating the hypothesis because it is unclear.  It will be hard for the reader to imaginie what is a performance vector until they see one.}
