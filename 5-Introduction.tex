...
\paragraph{Hypothesis 3:} Datasets with the same model parameters and data specific parameters create unique performance vector. \note{Behzad says : or Relative performance of each synthetic data type is unique} \note{Behzad says :or the relative performance of different models will be stable by the characteristic of a given type of data}
