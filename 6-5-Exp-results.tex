...
As explained before, the uniqueness characteristic of synthetic data signatures offers a means to identify the ground truth based on the similarity between the prototype performance from a synthetic data and the target \textit{performance vector} from the real data. In this experiment we used the measure form section \ref{Sigapproach-measure} as a degree of similarity between these vectors.
