...
\newcommand\DIFdelbegin %DIFDELCMD < \monTitre{Data driven means to validate and improve students models\note{not specific enough}}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \monTitre{Data driven means to validate and improve students models}
...
\newcommand\monJury{\PresidentJury{M}{Yann-Gael}{Gueheneuc}{Doctorat}\\
\DirecteurRecherche{M}{Michel C.}{Desmarais}{Ph.~D.}\\
\MembreJury{M}{Michel}{Gagnon}{Ph.~D.}\\
\MembreJury{M}{Jean-Jules}{Brault}{Ph.~D.}\\
